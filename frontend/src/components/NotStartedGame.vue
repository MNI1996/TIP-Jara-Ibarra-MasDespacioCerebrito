<template>
  <div class="not-started-game-container">
    <div class="row col-md-10 offset-md-1 welcome">
    ...
    <div class="row col-md-10 offset-md-1 game-information">
      <div class="col-md-7">
        <div class="row">
          <div class="col-md-3 game-info-div">
            <div class="row">
              <h2>Rondas</h2>
            </div>
            <div class="row">
          ...
          <div class="col-md-8 offset-md-1 game-info-div">
            <div class="row">
        ...
        <div class="row info-players">
          ...
          <div v-if="currentRoom.participants && currentRoom.participants.length > 0" class="col-md-12 row">
            <user-card v-for="participant in this.currentRoom.participants" :dato="participant" class="col-md-2"/>
          </div>
        </div>
      </div>
      <div class="col-md-5 ">
        <div class="info-categories">
          ...
          <div class="col-12" style="align-content: center">
            <div class="row">
              <div v-for="i in this.currentRoom.categories" class="col-md-3">
                <img :src="generateUrl(i)" alt="" class="img-fluid category-img">
